  ...
  return (
    <RoleGuard allowedRoles={['Owner']}>
      <div className="flex h-screen bg-gray-100">
        ...
        >
          <div className="p-4 border-b border-gray-700 font-bold text-center text-sm truncate">
            {isSidebarOpen ? 'Trang quản lý' : 'Chủ trọ'}
          </div>
          ...
          <nav className="flex-1 p-2 space-y-1 overflow-y-auto">
            ...
            <button
              ...
              className="mt-4 w-full text-left flex items-center gap-3 rounded px-2 py-2 text-sm transition-colors hover:bg-red-600 text-red-200 hover:text-white"
            >
              <span className="flex h-8 w-8 min-w-[2rem] items-center justify-center rounded-full text-xs font-semibold border border-red-400">
                ĐX
              </span>
            ...
            <div className="flex h-screen bg-gray-100">
                ...
                >
                    <div className="p-4 border-b border-gray-700 font-bold text-center truncate">
                        {isSidebarOpen ? "Cổng chủ nhà" : "Chủ nhà"}
                    </div>
